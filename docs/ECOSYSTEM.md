...
Not described: `hermes`, `openclaw` and `pi`. Three, not the
fifteen that "every descriptor without capabilities" suggests — project context hangs off a row, and the other twelve
